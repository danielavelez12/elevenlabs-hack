...
const AnimatedContent = styled(DialogPrimitive.Content)`
  animation: ${floatIn} 0.5s ease-in forwards;
  opacity: 0;
`;
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <AnimatedContent
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border bg-[#202533] p-6 shadow-lg duration-200 sm:rounded-lg text-white border-[#343645]",
        className
      )}
      {...props}
    >
